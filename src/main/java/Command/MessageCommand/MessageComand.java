...
public class MessageComand extends Command {
    ...
    private String generateMessageInstruction(Integer pageNo) {
        ...
        instruction += "[IMPT] You can send images/videos/documents and even stickers over BUT send them only after sending the /send message above!\n\n";
        instruction += "<em>View Messages for a particular year</em>\n";
        instruction += "<pre>  /view_msges &lt;year&gt;</pre>\n\n";
